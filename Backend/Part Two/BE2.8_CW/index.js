...
//user signup API
v1Routes.post("/signup", async (req, res) => {
  try {
...
v1Routes.post("/change-password", async (req, res) => {
  try {
...
v1Routes.post("/update-profile-picture", async (req, res) => {
  try {
...
v1Routes.post("/update-contact/:email", async (req, res) => {
  try {
...
v1Routes.get("/users/phone/:phoneNumber", async (req, res) => {
  try {
